...
const Tubular = () => {
   const [loading, setLoading] = useState(true);
    const [tubularItems, setTubularItems] = useState([]);
  ...
  useEffect(() => {
    ...
    const filteredItems = itemsData.filter((item) => item.id === "tubular");
    setTubularItems(filteredItems);
  }, []);
    ...
    <div>
     ...
     <div className="bg-gray-400 fixed w-full z-20">
          <div className="flex items-center justify-between max-w-[1200px] m-auto px-3 py-2">
            ...
            <h2 className="text-black text-[1.1rem] uppercase">Tubular Battries</h2>
            <div></div>{" "}
